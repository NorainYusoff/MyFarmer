...
String urlLogin = "http://lastyeartit.com//myfarmer_admin/login.php";
...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    SystemChrome.setSystemUIOverlayStyle(
        SystemUiOverlayStyle(statusBarColor: Color.fromRGBO(0,204,153,0.2)));
    return WillPopScope(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                MaterialButton(
                  ...
                  height: 50,
                  child: Text('Login'),
                  color: Color.fromRGBO(0,204,153,0.2),
